...
export const Trash = (props: IconProps) => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" {...props}>
    <g clip-path="url(#clip0_43_13479)">
      <path d="M3 5.25H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path
        d="M7.5 8.25V12.75"
        stroke="currentColor"
        stroke-width="1.5"
