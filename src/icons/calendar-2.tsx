...
export const Calendar2 = (iconsProps: IconProps) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...iconsProps}>
    <g clip-path="url(#clip0_223_15269)">
      <path
