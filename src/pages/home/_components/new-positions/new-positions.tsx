...
export const NewPositions = () => {
  ...
  const [getAllJobs, {data: {data: jobs = [], next_page} = {}, isFetching}] = useLazyGetAllJobsQuery()
  ...
  return (
    <section className="pt-[120px]">
      <div className="container">
        <h1 className="text-[#0b0b0b] text-[32px] font-medium font-['Inter Display']">New Positions</h1>
