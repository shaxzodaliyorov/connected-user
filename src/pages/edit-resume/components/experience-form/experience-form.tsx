...
import {useValidationOptions} from '@/hooks'
...
export const ExperienceForm = ({fields, form, index, remove}: Props) => {
  const getFieldName = useCallback((name: string) => `experience.${index}.${name}`, [index])
  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        <h1 className="text-[#0b0b0b] text-2xl font-medium font-['Inter Display'] leading-relaxed">Add experience</h1>
        {fields.length > 1 && (
          <button
            onClick={remove}
            ...
            <Input
              leftElement={
                <div className="border-r px-4 h-full flex items-center justify-center">
                  <p className="text-[#0b0b0b] text-base font-normal font-['Inter Display']">https://</p>
                </div>
              }
