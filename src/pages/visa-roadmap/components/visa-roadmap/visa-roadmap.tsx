...
// const VISA_STAGES_TEXT = [
//   'Student Visa',
//   'Job seeker Visa',
//   'Foreign National of Specially Ability Visa',
  ...
  return (
    <section className="w-full">
      <div className="w-full container">
        <h3 className="text-[32px] font-medium leading-[38.72px] text-left text-[#0C0C0C]">Joe’s recommended visas</h3>
