  ...
  return (
    <MainCard className="mt-6">
      <div className="flex justify-between">
        <h1 className="text-[32px] font-semibold leading-[51.2px] text-left text-[#161C1C]">
          {t("Skill Assessment")}
        </h1>
          ...
          <div className="flex items-center gap-x-2">
            ...
            <Popover>
              ...
              <PopoverContent className="w-auto">
                {ACCESSIBILITY.filter((c) => c.value !== accessibility).map(
                  ({ label, value }) => (
            ...
            <Popover>
              ...
              <PopoverContent className="w-auto">
                <div className="flex flex-col">
                  {LANGUAGES.filter((c) => c.value !== language).map(
                    ({ label, value }) => (
      ...
      <div className="pt-8">
        <Select
          ...
          errorMessage={
            !skill && isSubmitted ? "Please select your skill test" : undefined
          }
        />
      </div>
      <div>
        <p className="text-xl mt-6 font-semibold leading-8 text-left">
          {t("Test Overview")}
        </p>
        <ul className="list-disc pl-5 mt-2 space-y-1">
          <li className="text-base font-normal leading-6 text-left text-[#0C0C0C]">
            Each test is designed to evaluate your expertise in your chosen
            field.
          </li>
          <li className="text-base font-normal leading-6 text-left text-[#0C0C0C]">
            Tests are timed and include multiple-choice questions, practical
            tasks, and situational assessments.
          </li>
          <li className="text-base font-normal leading-6 text-left text-[#0C0C0C]">
            After completing the test, you will receive a skill certificate
            recognized by companies in South Korea.
          </li>
          <li className="text-base font-normal leading-6 text-left text-[#0C0C0C]">
            If you're not satisfied with your results, you can retake the test
            after a 7-day period to allow time for review and <br />{" "}
            improvement. Your highest score will be recorded, and you can
            continue to enhance your certificate over time.
          </li>
        </ul>
      </div>
      <div className="pt-10">
