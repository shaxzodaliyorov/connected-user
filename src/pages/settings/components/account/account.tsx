...
export const Account = () => {
  ...
  const onSubmit = async (formData: AccountFormValues) => {
    if (typeof avatar !== "string") {
      formData.profile_photo = (await handleFileUpload(
  ...
  return (
    <section className="w-full">
      <div>
        <h4 className="text-[#0c0c0c] text-[24px] font-medium leading-[38.72px] text-left">
          Basic Information
        </h4>
        ...
        <div className="w-full flex justify-between bg-[#FAFAFA] p-5 rounded-xl pt-5">
          <div className="">
            <h4 className="text-[#0c0c0c] text-[20px] font-medium leading-[38.72px] text-left">
              Photo
            </h4>
