...
export const ListItem = ({resumeItem}: Props) => {
  ...
  return (
    <div onClick={() => navigate(`/my-resume/${resumeItem._id}`)} className="w-full cursor-pointer">
      <MainCard>
        <div className="flex justify-between items-start">
          <div className="flex gap-5 items-center">
            <div className="relative">
              <img className="w-20 h-20 rounded-full" src={resumeItem.photo} alt="" />
            ...
            <div>
              <h3 className="text-xl font-medium leading-[22px] text-left">{resumeItem.position}</h3>
              <div className="pt-2">
                <p className=" text-base font-normal leading-6 text-left text-[#7D7D7D]">
                  {t('Updated on')} {dayjs(resumeItem.updated_at).format('DD.MM.YYYY')}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full rounded-xl flex justify-between bg-[#FAFAFA] p-5">
            ...
            <div className="flex gap-x-6 ">
              <div className="flex  gap-x-[6px] items-center">
                <span className="text-base font-normal leading-6 text-left text-[#0C0C0C]">{resumeItem.views}</span>
              ...
              <div className="flex gap-x-[6px] items-center">
                <span className="text-base font-normal leading-6 text-left text-[#0C0C0C]">{resumeItem.seen}</span>
                <span className="text-neutral-500 text-sm font-normal font-['Inter Display'] leading-[21px]">seen</span>
              </div>
              <div className="w-px h h-6 bg-[#C5C5C5] " />
              <div className="flex gap-x-[6px] items-center ">
                <span className="text-base font-normal leading-6 text-left text-[#0C0C0C]">{resumeItem.offers}</span>
                <span className="text-neutral-500 text-sm font-normal font-['Inter Display'] leading-[21px]">
                  offers
                </span>
              </div>
